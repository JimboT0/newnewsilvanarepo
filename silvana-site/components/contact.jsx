...
export default function Contact() {
    ...
    return (
        <div className="isolate bg-purple-50 px-6 pt-24 sm:py-32 lg:px-8">
            ...
            <Switch.Label className="text-sm leading-6 text-gray-600">
              ...
              .
                    ...
                    <div className="mt-2.5">
                        ...
                        <h3 class="mb-4 font-semibold text-indigo-800">Select Relevant Service</h3>
                        <ul class="items-center w-full text-sm font-medium text-gray-900 border border-gray-200 rounded-lg sm:flex bg-indigo-800 dark:text-white">
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    ...
                                    <label for="horizontal-list-radio-license" class="w-full py-3 ml-2 text-sm font-medium text-white dark:text-gray-300">Jewellery Design </label>
                                </div>
                            </li>
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    ...
                                    <label for="horizontal-list-radio-id" class="w-full py-3 ml-2 text-sm font-medium text-white dark:text-gray-300">Jewellery Restoration</label>
                                </div>
                            </li>
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    ...
                                    <label for="horizontal-list-radio-millitary" class="w-full py-3 ml-2 text-sm font-medium text-white dark:text-gray-300">Watch Repairs</label>
                                </div>
                            </li>
                            <li class="w-full dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    ...
                                    <label for="horizontal-list-radio-passport" class="w-full py-3 ml-2 text-sm font-medium text-white dark:text-gray-300">Jewellery Valuation</label>
                                </div>
                            </li>
                        </ul>
